    ...
    <section id="about" className="relative py-24 bg-gradient-to-br from-slate-900 via-blue-950/90 to-indigo-950/80 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-start">
        <div className="relative group animate-fade-in-up" style={{animationDelay: '0.3s'}}>
          <div className="aspect-[4/3] w-full rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border border-white/20 hover:shadow-3xl hover:scale-105 hover:rotate-1 transition-all duration-700 backdrop-blur-sm bg-gradient-to-br from-white/10 to-white/5">
            <img 
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-3 bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text">
                Kuldeep, CPA
              </h3>
              <p className="text-white/90 text-sm sm:text-base font-medium mb-4 leading-relaxed">Professional Excellence in Canadian Accounting</p>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="ml-2 text-yellow-200 text-xs sm:text-sm font-medium">Designated CPA</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="animate-fade-in-up">
          <div className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/20 via-blue-50/15 to-indigo-50/10 backdrop-blur-lg border-2 border-white/20 shadow-2xl">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="group flex items-center gap-4 p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/15 hover:shadow-xl hover:scale-105 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-xs sm:text-sm">QuickBooks • Xero • Sage 50</p>
                  </div>
                </div>
                ...
                <div className="group flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-teal-500/10 to-emerald-500/10 backdrop-blur-sm border border-teal-300/20 hover:bg-teal-500/15 hover:shadow-xl hover:scale-105 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-xs sm:text-sm">Serving remotely Canada wide</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 mt-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
          {/* Enhanced Why Choose Kempt CPA box */}
          <div className="group relative p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/95 via-blue-50/90 to-indigo-50/85 border-2 border-white/30 shadow-2xl hover:shadow-3xl hover:scale-105 hover:rotate-1 transition-all duration-500 backdrop-blur-lg min-h-[300px] sm:min-h-[400px]">
            {/* Magical background effects */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-400/5 via-indigo-400/3 to-cyan-400/2 rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-slate-900 text-lg sm:text-xl group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-indigo-600 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
              ...
              <div className="flex-1 space-y-4">
                <div className="p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-blue-200/50">
                  <p className="text-slate-800 text-sm sm:text-base font-semibold leading-relaxed font-serif">
          ...
          <div className="group relative p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/95 via-indigo-50/90 to-blue-50/85 border-2 border-white/30 shadow-2xl hover:shadow-3xl hover:scale-105 hover:-rotate-1 transition-all duration-500 backdrop-blur-lg min-h-[300px] sm:min-h-[400px]">
            {/* Magical background effects */}
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-400/5 via-blue-400/3 to-teal-400/2 rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-slate-900 text-lg sm:text-xl group-hover:bg-gradient-to-r group-hover:from-indigo-600 group-hover:to-blue-600 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
