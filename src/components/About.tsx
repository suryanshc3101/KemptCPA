    ...
    <section id="about" className="relative py-20 bg-gradient-to-br from-blue-50/60 via-slate-50/40 to-teal-50/30 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-start">
        <div className="relative group order-2 md:order-1">
          ...
          {/* Why Choose Kempt CPA box below image */}
          <div className="mt-6 aspect-square p-6 rounded-2xl bg-gradient-to-br from-slate-50 to-blue-50 border border-slate-200 hover:shadow-lg transition-all duration-300">
        ...
        <div className="relative order-1 md:order-2">
          ...
          {/* Professional Excellence box - now single column and square */}
          <div className="mb-6 max-w-md aspect-square p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 hover:shadow-lg transition-all duration-300">
