      ...
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between relative z-10">
        <div className="flex items-center">
          <div className="flex items-center gap-2" itemScope itemType="https://schema.org/Organization">
            ...
            <span itemProp="name" className="text-2xl font-bold bg-gradient-to-r from-blue-800 via-cyan-800 to-indigo-800 bg-clip-text text-transparent animate-text-shimmer cursor-default" title="Kempt CPA Professional Corporation">
              KemptCPA
            </span>
