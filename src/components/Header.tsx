    ...
    <div className="w-full glass-effect border-b border-blue-200/50 shadow-2xl backdrop-blur-lg relative overflow-hidden animate-magical-gradient bg-gradient-to-r from-white via-blue-50/40 to-indigo-50/30">
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center gap-2 sm:gap-4 lg:gap-6">
          <div className="hidden xl:flex items-center gap-2 glass-effect px-4 py-2 rounded-full animate-magical-pulse">
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-4 text-slate-600">
            <a href="tel:+15197717862" className="flex items-center gap-1 xl:gap-2 glass-effect px-2 xl:px-3 py-2 rounded-lg magical-hover">
              <Phone className="w-4 h-4 text-blue-600" />
              <span className="text-xs xl:text-sm font-medium">+1 519 771 7862</span>
            </a>
            <a href="mailto:info@kemptcpa.ca" className="flex items-center gap-1 xl:gap-2 glass-effect px-2 xl:px-3 py-2 rounded-lg magical-hover">
          ...
          <a 
            href="#contact" 
            className="group relative rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-600 via-cyan-600 to-indigo-600 text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 text-sm sm:text-base font-bold magical-hover animate-magical-glow shadow-2xl overflow-hidden"
          >
